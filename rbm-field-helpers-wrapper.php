...
if ( ! class_exists( 'RBM_Field_Helpers_Wrapper' ) ) {
	...
	class RBM_Field_Helpers_Wrapper {
		...
		/**
		 * @var			RBM_Field_Helpers_Wrapper $plugin_data Holds Plugin Header Info
		 * @since		1.0.0
		 */
		public $plugin_data;
		
		/**
		 * @var			RBM_Field_Helpers_Wrapper $admin_errors Stores all our Admin Errors to fire at once
		 * @since		1.0.0
		 */
